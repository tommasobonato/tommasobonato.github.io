...
let setThemeSetting = (themeSetting) => {
  ...
  document.documentElement.setAttribute("data-theme-setting", forced);
...
// Determine the expected state of the theme toggle. Force dark.
let determineThemeSetting = () => "dark";

// Determine the computed theme. Force dark.
...
let initTheme = () => {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (mode_toggle) mode_toggle.style.display = "none";
  });
};
